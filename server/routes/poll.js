...
module.exports = function addPollRoutes(router) {
  ...
  router.post('/polls/create', checkAuthentication, create);
  router.get('/polls/:id', detail);
  router.put('/polls/:id', update);
  router.delete('/polls/:id', checkAuthentication, deletePoll);
}
